  ...
  <div id="footer">
            ...
            <div class="col-sm-6">
              <div class="contact-info">
                ...
                <div class="box-text">
                  ...
                  <p># 55,St. 58P, Sangkat Phnom Penh Thmey ,
                  Khan Seasok, Phnom Penh, Cambodia.</p>
                </div>
              </div>
              <div class="contact-info">
                <div class="box-icon">
                  <img src="<?php echo $BATH_URL;?>assets/img/icon/Khmer-AdsZone-Phone-01.svg">
                </div>
                <div class="box-text">
                  <p class="bold">CALL US TODAY!</p>
                  <p>+855 17 518 100</p>
                  <p>+855 69 866 803</p>
                </div>
              </div>
              <div class="contact-info">
                ...
                <div class="box-text">
                  ...
                  <p><a href="">charboralg@gmail.com</a></p>
                  <p><a href="">www.facebook.com/greenlifepp/</a></p>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container">
      <div class="partner">
        ...
        <div class="box-img"><img src="<?php echo $BATH_URL;?>assets/img/Green-Life-Landscaping-service-Cambodia-Client-05.jpg"></div>
        <div class="box-img"><img src="<?php echo $BATH_URL;?>assets/img/Green-Life-Landscaping-service-Cambodia-Client-06.jpg"></div>
