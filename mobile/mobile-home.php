				...
				<div class="overview-service">
					<div class="text">
						<div class="title"><img src="<?php echo $BATH_URL?>assets/img/icon/tree-white.svg" alt="">
							<h3>SERVICES</h3></div>
							<div class="subtitle"><h3>POTTER PLANT GARDENING WATERING SYSTEM MAINTENANCE</h3></div>
						</div>
						<div class="box-img">
							<img src="<?php echo $BATH_URL?>assets/img/Green-Life-Landscaping-service-Cambodia-service-01.jpg" alt="">
						</div>
					</div>
						...
						<div class="text wow zoomIn">
							...
							<div class="qoute-plant">
								<div class="item wow zoomIn">
									...
									<div class="text">
										<p>MARCH 26, 2016</p>
										<h4>WHATEVER GOOD THINGS WE BUILD END UP GREEN FROM MIND</h4>
