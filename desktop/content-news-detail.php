...
?>
<link rel="stylesheet" type="text/css" href="<?php echo $BATH_URL;?>assets/css/desk-style-news-detail.css">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-8 right">
						...
						<div class="box-img">
							<img src="<?php echo $BATH_URL;?>assets/img/Green-Life-Landscaping-News-Cambodia-detials-04.jpg">
						</div>

						<div class="box-img">
							<img src="<?php echo $BATH_URL;?>assets/img/Green-Life-Landscaping-News-Cambodia-detials-06.jpg">
						</div>

						<div class="box-img">
							<img src="<?php echo $BATH_URL;?>assets/img/Green-Life-Landscaping-News-Cambodia-detials-05.jpg">
						</div>
					</div>
				</div>
			</div>
